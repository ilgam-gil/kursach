            ...
            <div id="article">
				<fieldset>
					<legend>Выберите действие</legend>
						...
						<form action="add_data_type_services.php" method="post"><input type="submit" name="submit" value="Добавить данные для таблицы type_services"><br></form>
						<form action="add_data_maintenance_services.php" method="post"><input type="submit" name="submit" value="Добавить данные для таблицы maintenance_services"><br></form>
						<form action="add_data_car_owners.php" method="post"><input type="submit" name="submit" value="Добавить данные для таблицы car_owners"><br></form>
